...
​
Then open:
<http://localhost:8765/seagrass_stories_classroom.html>

​
Project structure

seagrass_stories_classroom.html  Classroom learning page
...
Upload the project files, including the Activity Pack folder.
In the repository, open Settings > Pages.
Select Deploy from a branch.
Choose the main branch and the / (root) folder.
Open the generated Pages URL and add /seagrass_stories_classroom.html.
